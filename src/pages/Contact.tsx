                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <option value="communication">Communication Audit</option>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          placeholder="Describe your project, goals, and how we can help you achieve clarity in your communication..."
                        />
                      </div>
