          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            >
              <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
                ...
                <div className="space-y-6 mb-12">
                  {/* Your existing contact info unchanged */}
            ...
            >
              <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
                ...
                {submitted ? (
                  <div className="flex flex-col items-center justify-center text-center bg-green-50 border border-green-300 rounded-3xl p-12 shadow-lg min-h-[400px]">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    {/* your entire existing form fields here, exactly as you have them */}
                    {/* ... keep your current inputs, selects, checkboxes unchanged ... */}
                  </form>
                )}
              </div>
            </motion.div>
