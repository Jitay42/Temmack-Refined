    ...
    const testimonials = [
        {
            ...
            role: 'CEO',
            comment:
                'Temmack transformed our entire communication strategy. Our conversion rates increased by 340% within 3 months.',
            rating: 5,
        },
        {
            name: 'Marcus Johnson',
            ...
            comment:
                'Working with Temmack was a game-changer. They helped us find our voice and communicate our complex AI solutions clearly.',
            rating: 5,
        },
        {
            name: 'Priya Patel',
            ...
            role: 'Founder',
            comment:
                'The team at Temmack crafts strategic communication that drives real results. Our email open rates doubled overnight.',
            rating: 5,
        },
    ];
        ...
        <div className="min-h-screen">
            ...
            <section className="py-20 bg-gradient-to-br from-primary/5 via-white to-accent/5">
                <div className="max-w-4xl mx-auto text-center px-4">
                    ...
                    >
                        You're not invisible — you're just unclear. We help
                        brands speak boldly, sell better, and grow with
                        direction.
                    </motion.p>
                    <motion.div
                        initial={{ opacity: 0, y: 30 }}
            ...
            <section id="about" className="py-20 bg-background">
                <div className="max-w-5xl mx-auto px-4 text-center">
                    ...
                    <div className="space-y-8 text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto">
                        <p>
                            We founded Temmack to help brands say what they
                            mean—clearly and honestly. Too often, good ideas get
                            buried under jargon and clutter. We wanted to change
                            that.
                        </p>
                        <img
                        ...
                        />
                        <p>
                            Our mission is simple: make clarity a competitive
                            advantage. Because when people understand you, they
                            trust you. And when they trust you, they buy from
                            you.
                        </p>
                        <p>
                            We work with startups, SaaS companies, fintech
                            brands, NGOs, and small businesses that want to
                            connect with their audience in a real, human way.
                        </p>
                        <img
                        ...
                        />
                        <p>
                            Our values? Clarity first. Empathy over ego.
                            Strategic thinking. Honest work. Because effective
                            communication isn't about sounding clever—it's about
                            making sense.
                        </p>
                    </div>
                </div>
                ...
                <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-700 mb-8">
                            In a noisy world, clarity isn't optional. It's your
                            competitive edge. When your message is clear, your
                            audience understands you without effort—and that
                            leads to trust and action.
                        </p>
                        ...
                        <div className="bg-primary/10 rounded-3xl p-8 relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <blockquote className="text-2xl font-medium text-secondary mb-6 leading-relaxed">
                                    "The best marketing feels like a helpful
            ...
            <section className="py-20" style={{ backgroundColor: '#3b6eac' }}>
                <div className="max-w-7xl mx-auto px-4 text-center">
                    ...
                    <p className="text-xl text-white/90 mb-12">
                        Real results from real businesses who chose clarity over
                        confusion.
                    </p>
            ...
            <section
                id="contact"
                className="py-20 bg-secondary text-white text-center"
            >
                <div className="max-w-4xl mx-auto px-4">
                    <h2 className="text-4xl font-bold mb-6">Ready to Start?</h2>
                    <p className="text-xl mb-8">
                        Let's talk about how we can help you communicate with
                        clarity.
                    </p>
                    <Link
                        to="/contact"
