    ...
    const teamMembers: TeamMember[] = [
        {
            ...
            imageSrcSet:
                '/team/Fred Johanson.jpg 300w, /team/Fred Johanson@2x.jpg 600w',
        },
        {
            ...
            imageSrcSet:
                '/team/Jenifer Omashola.png 300w, /team/Jenifer Omashola@2x.png 600w',
        },
        {
            name: "Lex O'Brien",
            ...
            imageSrcSet:
                "/team/Lex O'Brien.png 300w, /team/Lex O'Brien@2x.png 600w",
        },
        {
            ...
            imageSrcSet:
                '/team/Akpovogaga David.png 300w, /team/Akpovogaga David@2x.png 600w',
        },
        {
            ...
            (entries) => {
                entries.forEach((entry) => {
                    if (entry.isIntersecting) {
                        const memberName =
                            entry.target.getAttribute('data-member-name');
        ...
        >
            <div className="max-w-[1200px] mx-auto px-6 lg:px-6">
                ...
                <div className="text-center mb-16">
                    ...
                    >
                        Five strategists, one mission: helping you communicate
